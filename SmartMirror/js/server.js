...
var Server = function(config, callback) {
	...
	app.get("/display.html", function(req,res){
		...
		exec("/upload/Test /upload/"+req.query.filename, function (error, stdout, stderr){
			console.log("Display success : "+req.query.filename);
		});
	});

	app.get("/close.html", function(req,res){
                exec("pkill -9 -ef /upload/Test", function (error, stdout, stderr){
