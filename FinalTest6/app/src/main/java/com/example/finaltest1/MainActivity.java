	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (id) {
			...
			case R.id.action_save_image:
                ...
                /*Mat src2 = new Mat(mBitmap2.getWidth(), mBitmap2.getHeight(), CvType.CV_8UC4);
                Utils.bitmapToMat(mBitmap2, src2);

                Mat dst2 = new Mat(mBitmap2.getWidth(), mBitmap2.getHeight(), CvType.CV_8UC4);
                Mat tmp2 = new Mat(mBitmap2.getWidth(), mBitmap2.getHeight(), CvType.CV_8UC4);
                Mat alpha2 = new Mat(mBitmap2.getWidth(), mBitmap2.getHeight(), CvType.CV_8UC4);

                Imgproc.cvtColor(src2, tmp2, Imgproc.COLOR_BGR2GRAY);
                Imgproc.threshold(tmp2, alpha2, 100, 255, Imgproc.THRESH_BINARY);
                ...
                rgba.add(rgb.get(2));
                rgba.add(alpha2);
                Core.merge(rgba, dst2);

                Bitmap output = Bitmap.createBitmap(mBitmap2.getWidth(), mBitmap2.getHeight(), Bitmap.Config.ARGB_8888);
                Utils.matToBitmap(dst2, output);*/
